...
@section('title','Welcone')

@push('extra_css')
    <link href="{{ asset ('public/assets/frontend/css/welcome/styles.css')}}" rel="stylesheet">

    <link href="{{ asset ('public/assets/frontend/css/welcome/responsive.css')}}" rel="stylesheet">
    <style>
        .favourite_posts{
            color: red;
        }
                ...
                @foreach ($categories as $category)
                    <div class="swiper-slide">
                        <a class="slider-category" href="{{ route('category.posts',$category->slug) }}">
                            <div class="blog-image"><img src="{{ asset('public/upload/categorySlider/'.$category->image) }}" alt="Blog Image">
                            </div>
