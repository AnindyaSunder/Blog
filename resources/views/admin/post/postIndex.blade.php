...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            ...
            <a class="btn btn-info waves-effect" href="{{ route('admin.post.create') }}"><i class="material-icons">add</i> <span style="font-size: 14px;">Add New</span> </a>
                                    ...
                                    @foreach ($posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form id="delete-{{ $post->id }}" action="{{ route('admin.post.destroy',$post->id) }}" method="POST" style="display: none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
