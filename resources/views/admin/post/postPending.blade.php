...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            ...
            <a class="btn btn-warning waves-effect" href=""><i class="material-icons">new_releases</i> <span style="font-size: 14px;">Approve All</span> </a>
